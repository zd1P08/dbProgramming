...
public class UpdateEventServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.setAttribute("levelId", event.getLevelId());
			request.setAttribute("content", event.getContent());
			request.setAttribute("userName", event.getUserName());
			request.setAttribute("eventId", event.getEventId());

			request.getRequestDispatcher("/WEB-INF/view/updateEvent.jsp").forward(request, response);
		} catch (Exception e) {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.setAttribute("eventIdError", "不正なデータです。");
			isError = true;
		}
		...
		try {
			...
			request.setAttribute("update", "編集が完了しました。");
			request.getRequestDispatcher("/WEB-INF/view/updateEventDone.jsp").forward(request, response);
		} catch (Exception e) {
			throw new ServletException(e);
		}
	}
